...
def iniciar_driver():
    print("Iniciando o driver do navegador...")
...
def site_produto(driver):
    ...
    # pegar preço
    try:
        print("Tentando capturar o preço do produto...")
        ...
        if len(element_precos) >= 2:
            ...
            print("Não foi possível encontrar o segundo elemento de preço.")
            return None
    except NoSuchElementException:
        print("Elemento de preço não encontrado. Verifique se o seletor CSS está correto ou se o elemento está presente na página.")
        return None
